    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                var discountPrice = book.priceOld - Math.round(book.priceOld * book.price);
                return '<div class="Card">' +
                    ...
                    '<div class="Card-description">' + book.authors.join(', ') + '</div>\n' +
                    '<div class="Card-description">' + 'pub: '+book.pub + '</div>\n' +
                    '<div class="Card-cost">' +
